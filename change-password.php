...
<head>
    ...
    <title>SNF | Change Password</title>
...
<div id="InvoiceContent" style="padding-top: 0;"> 
    ...
    <h1 style="text-align: center; margin: 10px 0 20px 0;" class="gradient-text-green">Change Password</h1>
    <?php
    ...
    <form method="post" action="auth.php" class="form">
        ...
        <div class="form-group row mb-2">
            ...
            <div class="col-8">
                <div class="input-group mb-2">
                    <input type="password" name="CurrentPassword"  id="oldpassword" value="<?php if (isset($_SESSION['current_password'])) { echo htmlspecialchars($_SESSION['current_password']); unset($_SESSION['current_password']); } ?>" class="form-control" style="border-top: 0; border-left: 0; border-right: 0;" required>
                    <i id="oldtogglePassword" style="position: absolute; right: 5px; bottom: 5px; cursor: pointer;" class="fas fa-fw fa-eye-slash"></i> 
                    <i id="oldtogglePasswordVisible" style="display:none; position: absolute; right: 5px; bottom: 5px; cursor: pointer;" class="fas fa-fw fa-eye"></i> 
                </div>
            </div>
        </div>  
        ...
        <?php
            if (isset($_SESSION['currentpassword'])) {
                echo '<p class="message" style="color: red; text-align: center;">'.$_SESSION['currentpassword'].'</p>';
        ...
        <div class="form-group row mb-2">
            ...
            <div class="col-8">
                <div class="input-group mb-2">
                    <input type="password" name="NewPassword"  id="newpassword" value="<?php if (isset($_SESSION['new_password'])) { echo htmlspecialchars($_SESSION['new_password']); unset($_SESSION['new_password']); } ?>" class="form-control" style="border-top: 0; border-left: 0; border-right: 0;" required>
                    <i id="newtogglePassword" style="position: absolute; right: 5px; bottom: 5px; cursor: pointer;" class="fas fa-fw fa-eye-slash"></i> 
                    <i id="newtogglePasswordVisible" style="display:none; position: absolute; right: 5px; bottom: 5px; cursor: pointer;" class="fas fa-fw fa-eye"></i> 
                </div>
            </div>
        </div>  
        ...
        <div class="form-group row mb-2">
            ...
            <div class="col-8">
                <div class="input-group mb-2">
                    <input type="password" name="ConfirmNewPassword"  id="confirmpassword" value="<?php if (isset($_SESSION['confirm_password'])) { echo htmlspecialchars($_SESSION['confirm_password']); unset($_SESSION['confirm_password']); } ?>" class="form-control" style="border-top: 0; border-left: 0; border-right: 0;" required>
                    <i id="confirmtogglePassword" style="position: absolute; right: 5px; bottom: 5px; cursor: pointer;" class="fas fa-fw fa-eye-slash"></i> 
                    <i id="confirmtogglePasswordVisible" style="display:none; position: absolute; right: 5px; bottom: 5px; cursor: pointer;" class="fas fa-fw fa-eye"></i> 
                </div>
            </div>
        </div>  
...
<script>
    document.getElementById('oldtogglePassword').addEventListener('click', function () {
        const passwordField = document.getElementById('oldpassword');
        const togglePassword = document.getElementById('oldtogglePassword');
        const togglePasswordVisible = document.getElementById('oldtogglePasswordVisible');
    ...
    document.getElementById('oldtogglePasswordVisible').addEventListener('click', function () {
        const passwordField = document.getElementById('oldpassword');
        const togglePassword = document.getElementById('oldtogglePassword');
        const togglePasswordVisible = document.getElementById('oldtogglePasswordVisible');
